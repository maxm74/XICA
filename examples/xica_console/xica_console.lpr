...
uses
  ...
  XICA_Types, XICA_Classes, XICA_PaperSizes, XICA;

resourcestring
  rsNoDevicePresent = 'No Wia Devices present...';
  rsDeviceSelect = 'Select a Device to use :';
...
type
  { TXICADemoApplication }
  TXICADemoApplication = class(TObject)
  protected
    lres: HResult;
    FWia: TXICA_Manager;
    WIASource: TXICA_Device;
    WIAParams: TArrayXICA_Params;   //for semplicity i only use the [0] array item
    WIACap: TXICA_ParamsCapabilities;
    WIAformat,
    WIAformatDef: TXICA_ImageFormat;
    WIAFormatSet: TXICA_ImageFormats;
    WIAformatStr: String;
...
procedure TXICADemoApplication.Run;
var
  ch: String;
  dIndex,
  iIndex: Integer;
...
procedure TXICADemoApplication.Acquire;
var
   aPath, aExt: String;
   c: Integer;
...
constructor TXICADemoApplication.Create;
begin
  inherited Create;
...
destructor TXICADemoApplication.Destroy;
begin
  WIAParams:= nil;
...
function TXICADemoApplication.DeviceTransferEvent(AWiaManager: TWIAManager; AWiaDevice: TWIADevice;
                                          lFlags: LONG; pWiaTransferParams: PWiaTransferParams): Boolean;
begin
  Result:= True;
...
var
  Application: TXICADemoApplication;
  hr : HRESULT;
...
begin
  ...
  Application:= TXICADemoApplication.Create;
  Application.Run;
  Application.Free;
