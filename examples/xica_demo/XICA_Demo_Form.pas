...
procedure TFormXICADemo.FormCreate(Sender: TObject);
begin
...
procedure TFormXICADemo.FormDestroy(Sender: TObject);
begin
  WIAParams:= nil;
  if (FWIA<>nil) then FWia.Free;
end;

function TFormXICADemo.DeviceTransferEvent(AWiaManager: TWIAManager; AWiaDevice: TWIADevice;
                                          lFlags: LONG; pWiaTransferParams: PWiaTransferParams): Boolean;
begin
  Result:= True;
...
procedure TFormXICADemo.btSelectClick(Sender: TObject);
var
...
procedure TFormXICADemo.btNativeClick(Sender: TObject);
var
   aPath: String;
   WIASource: TWIADevice;
   c: Integer;
...
procedure TFormXICADemo.btBrowseClick(Sender: TObject);
var
   ADir: String;
...
procedure TFormXICADemo.btAcquireClick(Sender: TObject);
var
   aPath, aExt: String;
   WIASource: TWIADevice;
   SelectedItemIndex,
